...
function loadClasses($classname)
{
	...
	{
		var_dump(__DIR__."/".$classname.'.class.php');
		if(is_file(__DIR__."/".$classname.'.class.php'))
		{
			require __DIR__."/".$classname.'.class.php';
		}
		else if(is_file( __DIR__."/specifiques/".$classname.'.class.php'))
		{
			require __DIR__."/specifiques/".$classname.'.class.php';
		}
	}
}
