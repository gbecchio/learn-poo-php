...
class SeekableIteratorArrayTest extends PHPUnit_Framework_TestCase
{
    private $_object1;
    private $_table1;
    ...
    protected function setUp()
    {
        ...
        $this->_object1 = new SeekableIteratorArray($this->_table1);
    }
    ...
    {
    	$this->_object1->seek(5);
    	$this->assertEquals($this->_object1->key(), 5);
    	$this->_object1->seek(6);
    	$this->_object1->seek('rien');
    }
}